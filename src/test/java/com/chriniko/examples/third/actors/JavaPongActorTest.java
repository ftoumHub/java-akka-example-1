...
public class JavaPongActorTest {
    ...
    private static ActorRef pongActorRef;

    @BeforeClass
    public static void setup() {
        system = ActorSystem.create();

        pongActorRef = system.actorOf(JavaPongActor.props());
    }
    ...
    public void should_reply_to_ping_message_with_pong_message() throws InterruptedException, ExecutionException, TimeoutException {
        ...
        //when...
        Future resultWhenWeSentPingMessage_Scala = Patterns.ask(pongActorRef, "ping", 5000);

        //then...
        CompletableFuture cs = toJava(resultWhenWeSentPingMessage_Scala).toCompletableFuture();
    ...
    public void should_reply_to_unknown_message_with_failure() {
        ...
        //when...
        Future resultWhenWeSentUnknownMessage_Scala = Patterns.ask(pongActorRef, "___wrong___", 5000);

        //then...
        CompletableFuture cs = toJava(resultWhenWeSentUnknownMessage_Scala).toCompletableFuture();
    ...
    private CompletionStage<Object> askPongActor(String message) {
        Future<Object> result = Patterns.ask(pongActorRef, message, 5000);
